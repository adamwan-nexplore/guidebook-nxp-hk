...
### 4.4.1 EXPLAIN & Query Plan

- IF you are unsure of how the query performance, try `EXPLAIN` or `EXPLAIN ANALYZE`
...
- `Hash Index` could be a good choice UNDER a few circumstances
...
### 4.4.1.3 Micro-optimization 

- Good for frequently used query 
...
-- Can only use Index on Expressions, IF the length of SEARCH token is FIXED
